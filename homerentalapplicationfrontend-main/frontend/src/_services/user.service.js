...
class UserService {
    ...
    async getAdminListings() {
        const result = await axios.get(API + "/admin/listings", {
            headers: authHeader(),
        });
        return result;
    }
    ...
    async getAllUserInfo(userId) {
        const result = await axios.get(API + `/admin/users/${userId}/full`, {
            headers: authHeader(),
        });
        return result;
    }
    ...
    async getAdminReviews() {
        const result = await axios.get(API + "/admin/reviews", {
            headers: authHeader(),
        });
        return result;
    }
    ...
    async getCurrentListing(listingId) {
        const result = await axios.get(API + `/listings/${listingId}`, {
            headers: authHeader(),
        });
        return result;
    }
    ...
    async getCurrentReview(reviewId) {
        const result = await axios.get(API + `/reviews/${reviewId}`, {
            headers: authHeader(),
        });
        return result;
    }
    ...
    async getCurrentBooking(bookingId) {
        const result = await axios.get(API + `/guest/bookings/${bookingId}`, {
            headers: authHeader(),
        });
        return result;
    }
    ...
    async getHostBoard() {
        const result = await axios.get(API + "/host/listings", {
            headers: authHeader(),
        });
        return result;
    }
    ...
    async getHostBookings() {
        const result = await axios.get(API + "/host/bookings", {
            headers: authHeader(),
        });
        return result;
    }
    ...
    async getHostReviews() {
        const result = await axios.get(API + "/host/reviews", {
            headers: authHeader(),
        });
        return result;
    }
    ...
    async getHostMessages(listingId) {
        const result = await axios.get(
            API + `/host/listings/${listingId}/messages`,
            { headers: authHeader() }
        );
        return result;
    }
    ...
    async getGuestBoard() {
        const result = await axios.get(API + "/guest/bookings", {
            headers: authHeader(),
        });
        return result;
    }
    ...
    async getUserById(id) {
        const result = await axios.get(API + `/admin/users/${id}`, {
            headers: authHeader(),
        });
        return result.data;
    }
    ...
    async getReviewById(id) {
        const result = await axios.get(API + `/admin/reviews/${id}`, {
            headers: authHeader(),
        });
        return result.data;
    }
    ...
    approveHost(hostId) {
        return axios.put(
            API + `/admin/users/${hostId}/approve`,
            {},
            { headers: authHeader() }
        );
    }
    ...
    postPhoto(imageFile) {
        return axios.post(API + "/images/upload", imageFile, {
            headers: {
    ...
    linkUserPhoto(imageFile, userId) {
        ...
        return axios.put(API + "/images/update", modifiedImage, {
            headers: authHeader(),
        });
    }
    ...
    hostMessageSeen(listingId) {
        return axios.put(
            API + `/host/messages/${listingId}/seen`,
            {},
            { headers: authHeader() }
        );
    }
