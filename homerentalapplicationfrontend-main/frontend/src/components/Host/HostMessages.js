...
class HostMessages extends Component {
    ...
    handleDelete = (e) => {
        ...
        UserService.getHostMessages(listingId).then((response) => {
            this.setState({
    ...
    render() {
        ...
        const indexOfLastMessage =
            this.state.currentPage * this.state.messagesPerPage;
        const indexOfFirstMessage =
            indexOfLastMessage - this.state.messagesPerPage;
        ...
        return (
            <React.Fragment>
                ...
                >
                    ...
                    />
                    <Pagination
                        resultsPerPage={this.state.messagesPerPage}
