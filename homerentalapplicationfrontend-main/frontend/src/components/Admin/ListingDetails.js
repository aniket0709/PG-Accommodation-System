        ...
        return (
            ...
            >
                ...
                <ul style={{ display: "flex", flexDirection: "column" }}>
                    ...
                    <li>
                        <h4>
                            <strong>ID: {this.state.listing.id}</strong>
                        </h4>
                    </li>
                    <li>
                        <h4>
                            <strong>State: {this.state.listing.state}</strong>
                        </h4>
                    </li>
                    <li>
                        <h4>
                            <strong>City: {this.state.listing.city}</strong>
                        </h4>
                    </li>
                    <li>
                        <h4>
                            <strong>
                                Postal Code: {this.state.listing.postalCode}
                            </strong>
                        </h4>
                    </li>
