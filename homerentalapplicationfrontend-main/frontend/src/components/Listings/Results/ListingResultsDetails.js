...
class ListingResultsDetails extends Component {
    ...
    render() {
        ...
        return (
            <div className="listing-overview" style={{ marginTop: "0px" }}>
                <div className="overview-inner">
                    ...
                    <ul style={{ display: "flex" }}>
                        <ul
                            className="listing-results-details"
                            style={{
                                position: "relative",
                        ...
                        >
                            ...
                            <li>
                                ...
                                >
                                    {this.state.listing.type.replace("_", " ")}
                                </h4>
                            </li>
                            <li>
                                <h3
                                ...
                                >
                                    <br />
                                    Rooms: {this.state.listing.numOfRooms}
                                </h3>
                            </li>
                            <li>
                                <h3
                                ...
                                >
                                    Beds: {this.state.listing.numOfBeds}
                                </h3>
                            </li>
                            <li>
                                <h3
                                ...
                                >
                                    Washrooms:{" "}
                                    {this.state.listing.numOfWashrooms}
                                </h3>
                            </li>
                            <hr></hr>
                            <li>
                                <h3 style={{ color: "black" }}>
                                    <br />
                                    Other amenities {this.state.listing.number}
                                </h3>
                            </li>
                            <ul
                                style={{
                            ...
                            >
                                {this.state.listing.kitchen && (
                                    <li>
                                        <h5>Kitchen &#10004;</h5>
                                    </li>
                                )}
                                {this.state.listing.parking && (
                                    <li>
                                        <h5>Parking &#10004;</h5>
                                    </li>
                                )}
                                {this.state.listing.elevator && (
                                    <li>
                                        <h5>Elevator &#10004;</h5>
                                    </li>
                                )}
                                {this.state.listing.smoking && (
                                    <li>
                                        <h5>Smoking &#10004;</h5>
                                    </li>
                                )}
                                {this.state.listing.tv && (
                                    <li>
                                        <h5>TV &#10004;</h5>
                                    </li>
                                )}
                                {this.state.listing.ac && (
                                    <li>
                                        <h5>AC &#10004;</h5>
                                    </li>
                                )}
                                {this.state.listing.heating && (
                                    <li>
                                        <h5>Heating &#10004;</h5>
                                    </li>
                                )}
                                {this.state.listing.wifi && (
                                    <li>
                                        <h5>WiFi &#10004;</h5>
                                    </li>
                                )}
                                {this.state.listing.parties && (
                                    <li>
                                        <h5>Parties &#10004;</h5>
                                    </li>
                                )}
                                {this.state.listing.animals && (
                                    <li>
                                        <h5>Animals &#10004;</h5>
                                    </li>
                                )}
                            ...
                            <hr></hr>
                            <li>
                                <h4>{this.state.listing.price} Rs/day</h4>
                            </li>
                        ...
                        <li style={{ width: "40%" }}>
                            ...
                            >
                                ...
                                <li>
                                    ...
                                    >
                                        Phone: {this.state.listing.host.number}
                                    </h4>
                                </li>
                                <li>
                                    <Link
                                    ...
                                    >
                                        <MessageIcon /> <h5>Have Questions?</h5>
                                    </Link>
                                </li>
                            </ul>
                        </li>
