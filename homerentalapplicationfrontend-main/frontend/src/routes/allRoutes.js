...
import HostBooking from "../components/Host/HostBooking";
import HostReview from "../components/Host/HostReview"
    ...
    return (
        <Switch>
            ...
            <Route
                ...
                component={ListingResultsDetails}
            />
            ...
            <HostRoute
                ...
                component={HostListingsDetails}
            />
            <HostRoute exact path="/host/messages" component={HostMessages} />
            
            <HostRoute
                exact
                path="/host/messages/:messageId"
                component={HostMessageReply}
            />
            <HostRoute exact path="/host/bookings" component={HostBooking} />
            <HostRoute exact path="/host/reviews" component={HostReview} />
